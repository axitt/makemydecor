let welcomebabyList = [
  ...
  var welcomebabyHTML;
  welcomebabyHTML = '<div class="container"> <div class="row">';
  ...
  welcomebabyList.forEach(function(list) {
    welcomebabyHTML+=`
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Welcome Baby Decoration</h5>
  ...
  document.getElementById("welcome-baby-details").innerHTML = welcomebabyHTML;